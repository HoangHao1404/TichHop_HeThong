...
//! 2. Cấu hình cơ bản
const queue = "products_queue";      // Tên hàng đợi RabbitMQ
...
async function sendProducts() {
    ...
    const rows = await db.all("SELECT * FROM Products"); // Mỗi row là 1 object sản phẩm
    ...
    for (const row of rows) {
        ...
        console.log("📤 Sent Product:", row);                    // Log mỗi bản ghi
    }
    ...
    await db.close();
    console.log("✅ All Products sent to RabbitMQ");
}

//! 9. Thực thi hàm và xử lý lỗi
sendProducts()
    .then(() => console.log("✅ Done sending products"))
